                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        readOnly
                                        className="w-full border border-gray-300 bg-gray-100 rounded-md px-4 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    />
                                </div>
                            </div>
                            <div>
                                ...
                                <input
                                    type="text"
                                    id="dob"
                                    defaultValue={user?.dateOfBirth ? new Date(user.dateOfBirth).toLocaleDateString() : ''}
                                    className="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                />
                            </div>
                        </div>
