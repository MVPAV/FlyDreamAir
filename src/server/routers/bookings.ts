            ...
            if (process.env.POSTMARK_CLIENT) {
                ...
                await client.sendEmailWithTemplate({
                    ...
                    TemplateModel: {
                        ...
                        manage_booking_url: `https://flydreamair-552450687331.europe-west1.run.app/manage-booking/?reference=${newBooking.bookingCode}&lastName=${booking.passengers[0].lastName}`,
                        support_email: "support@flydreamair-552450687331.europe-west1.run.app",
                        help_url: "https://flydreamair-552450687331.europe-west1.run.app/help",
